...
def main():
    if len(sys.argv) < 3:
        print("Usage: python deduplicate_configs.py <input.txt> <output.json>")
        sys.exit(1)
    ...
    # Config file path
    config_file = sys.argv[1] #"configs/proxy_configs.txt"
    ...
    checker.save_deduplicated_configs(output_file)
